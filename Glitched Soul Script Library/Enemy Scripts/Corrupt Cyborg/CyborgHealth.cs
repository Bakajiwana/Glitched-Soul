...
public class CyborgHealth : MonoBehaviour {
	...
	public CyborgMeleeScript cyborgScript; //script from enemy cyborg
	...
	public void applyEnemyDamage (float _damage)
	{
		...
		//Update player location and alert self 
		if(player && PlayerUpgrade.corrupt == false)
		{
			cyborgScript.destination.position = player.position; //Update player location
		}
